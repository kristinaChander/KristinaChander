...
public class TestData {
    ...
    public static final String ONE_UKRAINIAN_WORD_WRONG_SPELLING = "прривіт";
    ...
    public static final String ONE_UKRAINIAN_WORD_CORRECT_SPELLING = "привіт";
    ...
    public static final String SENTENCE_UKRAINIAN_WRONG_SPELLING = "Кожа лдина ioмає прppво на оoсвіту";
    ...
    public static final String SENTENCE_UKRAINIAN_CORRECT_SPELLING = "Кожна людина має право на освіту";

    public static final String ENGLISH_WORD_WITH_CAPS = "hELLO";
    public static final String RUSSIAN_WORD_WITH_CAPS = "пРИВет";
    public static final String UKRAINIAN_WORD_WITH_CAPS = "пРИВіт";
    ...
    public static final String SENTENCE_UKRAINIAN_DUPLICATION = "привіт привіт привіт привіт";
