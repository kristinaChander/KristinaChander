...
public class IncorrectSpellingTest extends SetUpFunctionalLevel {
    ...
    public Object[][] correctAndErrorWordsAndCodes() {
        return new Object[][]{
                ...
                {ONE_UKRANIAN_WORD_WRONG_SPELLING, ONE_UKRANIAN_WORD_CORRECT_SPELLING, ERROR_CODE_NOT_IN_THE_DICTIONARY, UKRANIAN_LANG},
        };
    }
    ...
    public Object[][] errorSentenceAndLang() {
        return new Object[][]{
                ...
                {SENTENCE_UKRANIAN_WRONG_SPELLING, UKRANIAN_LANG},
        };
    }
    ...
    void incorrectSentenceTest(String sentence, String lang) {
        ...
        spellerAssertions.verifyNotEmptyBody();
    }
}
